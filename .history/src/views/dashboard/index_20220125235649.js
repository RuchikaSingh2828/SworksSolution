...
import { FeedConsumer } from '../../context/feedContext';
        ...
        <Row>
          <Col lg={8} className="row m-0 p-0">
            ...
            {feedArr.map((feed, index) => (
              <Col key={feed.userId + index} sm={12}>
                          ...
                          <div className="d-flex justify-content-between">
                            <div>
                              ...
                              <p className="mb-0 text-primary">
                                {feed.timeDifference.split('D')[0] == '1'
                                  ? `${
                                      feed.timeDifference.split('D')[0]
                                    } day ago`
                                  : `${
                                      feed.timeDifference.split('D')[0]
                                    } days ago`}
                          ...
                          <div className="user-post">
                            <div className="ratio ratio-16x9">
                              <video
                                ...
                                width="640"
                                height="480"
                                poster={feed.attachments[0].thumbnailUrl}
                                muted
                              >
                                <source
                                  src={feed.attachments[0].url}
